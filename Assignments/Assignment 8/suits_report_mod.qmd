...
format:
  html:
    theme: superhero  # Bootstrap theme
    toc: true  # Enable table of contents
    toc-location: left  # Set the TOC to the left
    code-fold: true  # Collapse code blocks by default
    code-tools: true  # Show buttons to copy or collapse code
    tabs:
      - {.tabset}  # Enable tabs
  pdf: default
  docx: default
...
Note: to get the PDF, Jupyter outputs run `quarto render suits_report_mod.qmd` in terminal. 
